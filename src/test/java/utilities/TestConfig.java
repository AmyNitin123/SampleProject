...
public class TestConfig{
	...
	public static String from = "amruthapb2@gmail.com";
	public static String password = "25victoriastreet";
	public static String[] to ={"amruthapb2@gmail.com","trainer@way2automation.com"};
